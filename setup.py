...
try:
    ...
    print("S3Dump now needs setuptools in order to build. Install it using"
          " your package manager (usually python-setuptools) or via pip (pip"
          " install setuptools).", file=sys.stderr)
    sys.exit(1)

sys.path.insert(0, os.path.abspath('lib'))
from s3dump.release import __version__, __author__
...
def _find_symlinks(topdir, extension=''):
    ...
    .. warn::
        We want the symlinks in :file:`bin/` that link into :file:`lib/s3dump/*` (currently,
        :command:`s3dump`) to become
...
static_setup_params = dict(
    ...
    name="s3dump",
    version=__version__,
    description="Security Tool for look and download files in S3 Buckets",
    author=__author__,
    author_email="alanplacidina@gmail.com",
    project_urls={
        'Bug Tracker': "https://github.com/Placidina/s3dump/issues",
        'Source Code': "https://github.com/Placidina/s3dump",
    },
